"""Account-scoped financial state and reconciliation contracts.

The execution stack consumes explicitly observed broker state or explicitly
configured paper state. No universal minimum capital or synthetic balance is
created here.
"""
