"""Reconcile local order state with broker observations."""
...
class OrderReconciler:
    """Compare locally recorded order state with a broker snapshot."""
    ...
    def reconcile(
        ...
        *,
        ...
        return OrderReconciliationResult(local.order_id, OrderReconciliationStatus.MATCHED, "order state matches")
